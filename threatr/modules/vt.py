...
def _get_vt_threat_cat_and_name(response):
    ...
    if 'popular_threat_classification' in response and response['popular_threat_classification']:
        ...
        if classification['popular_threat_category']:
            cat = '/'.join([e['value'] for e in classification['popular_threat_category']])
